package filter;
/* Даний клас створно для перерахунку іменованих констант, в даному випадку областей.

Також у класі є метод switch який дозволяє здійснити подальший вибір необхідної області.
